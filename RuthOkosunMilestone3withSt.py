...
#company_list =  tech_list #[ COST, BKNG]
...
# Comparing a stock to itself should show a perfectly linear relationship
sns.jointplot(data=tech_rets, kind='scatter', color='seagreen')

# We'll use joinplot to compare the daily returns of Google and Microsoft
sns.jointplot(data=tech_rets, kind='scatter')
...
closing_df = closing_df.to_frame().reset_index()
